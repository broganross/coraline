...
# path to the coraline windows libraries
os.environ.setdefault("CORAL_WIN_LIBS_PATH", os.path.abspath("../../coraline_win_libs")) 
...
os.environ["CORAL_IMATH_INCLUDES_PATH"] = os.environ["CORAL_WIN_LIBS_PATH"] + "/vs10_x64/openexr/include"
os.environ["CORAL_IMATH_LIBS_PATH"] = os.environ["CORAL_WIN_LIBS_PATH"] + "/vs10_x64/openexr/lib"
os.environ["CORAL_IMATH_LIB"] = "Imath"
os.environ["CORAL_IMATH_IEX_LIB"] = "Iex"

os.environ["CORAL_OIIO_INCLUDES_PATH"] = os.environ["CORAL_WIN_LIBS_PATH"] + "/vs10_x64/openimageio/include"
os.environ["CORAL_OIIO_LIBS_PATH"] = os.environ["CORAL_WIN_LIBS_PATH"] + "/vs10_x64/openimageio/lib"
os.environ["CORAL_OIIO_LIB"] = "OpenImageIO"

os.environ["CORAL_TBB_INCLUDES_PATH"] = os.environ["CORAL_WIN_LIBS_PATH"] + "/vs10_x64/tbb/include"
os.environ["CORAL_TBB_LIBS_PATH"] = os.environ["CORAL_WIN_LIBS_PATH"] + "/vs10_x64/tbb/lib"
os.environ["CORAL_TBB_LIB"] = "tbb"

os.environ["CORAL_GLEW_INCLUDES_PATH"] = os.environ["CORAL_WIN_LIBS_PATH"] + "/vs10_x64/glew/include"
os.environ["CORAL_GLEW_LIBS_PATH"] = os.environ["CORAL_WIN_LIBS_PATH"] + "/vs10_x64/glew/lib"
os.environ["CORAL_GLEW_LIB"] = "glew32"

os.environ["CORAL_CL_INCLUDES_PATH"] = os.environ["CORAL_WIN_LIBS_PATH"] + "/vs10_x64/opencl/include"
os.environ["CORAL_CL_LIBS_PATH"] = os.environ["CORAL_WIN_LIBS_PATH"] + "/vs10_x64/opencl/lib/x64"
